...
void xnn_qs8_gemm_minmax_ukernel_12x8c4__neondot(
  ...
  do {
    ...
    if (nc >= 8) {
      ...
      a4 = (const int8_t*) ((uintptr_t) a4 - (kc - k));
      a5 = (const int8_t*) ((uintptr_t) a5 - (kc - k));
      a6 = (const int8_t*) ((uintptr_t) a6 - (kc - k));
      a7 = (const int8_t*) ((uintptr_t) a7 - (kc - k));
      a8 = (const int8_t*) ((uintptr_t) a8 - (kc - k));
      a9 = (const int8_t*) ((uintptr_t) a9 - (kc - k));
      a10 = (const int8_t*) ((uintptr_t) a10 - (kc - k));
      a11 = (const int8_t*) ((uintptr_t) a11 - (kc - k));
